...
def test_exact_gift_match():
    ...
    data = resp.json()
    assert data["id"] == "grok-36d81c34-d3c6-4602-8a14-0b966b7c8176-720p" or data["id"] == "04"
...
def test_regex_gift_match():
    ...
    assert resp.status_code == 200
    data = resp.json()
    assert data["id"] == "grok-36d81c34-d3c6-4602-8a14-0b966b7c8176-720p" or data["id"] == "02"
...
def test_wildcard_default():
    ...
    assert resp.status_code == 200
    data = resp.json()
    assert data["id"] == "grok-36d81c34-d3c6-4602-8a14-0b966b7c8176-720p" or data["id"] == "05"
