...
class VideoService:
    ...
    def get_next_video(self, trigger: Optional[str] = None) -> str:
        """
    ...
    def set_scenario(self, scenario: str):
        """Forces a specific scenario sequence (legacy/compatibility)."""
        # You could implement scenario logic based on the new config if needed
        logger.info(f"Scenario {scenario} requested but sequence logic is now dynamic.")
