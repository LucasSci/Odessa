...
if (!SESSION_SECRET) throw new Error("ODESSA_SESSION_SECRET environment variable must be set");
const AGENT_TOKEN = (process.env.ODESSA_AGENT_TOKEN || '').trim();
if (!AGENT_TOKEN) throw new Error("ODESSA_AGENT_TOKEN environment variable must be set");
